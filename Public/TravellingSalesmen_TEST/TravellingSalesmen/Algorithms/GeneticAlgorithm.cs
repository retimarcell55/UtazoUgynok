...
namespace TravellingSalesmen.Algorithms
{
    class GeneticAlgorithm : Algorithm
    {
        ...
        static double weakParentRate = 0.255;
        ...
        private double WEAK_PARENT_RATE = weakParentRate;
        ...
        {
            String[] temp = { generationsNumber.ToString(), populationSize.ToString(), mutationProbability.ToString(), weakParentRate.ToString(), firstchildMutationTrue.ToString(), secondchildMutationTrue.ToString() };
            return temp;
        }
    }
